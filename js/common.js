...
if ( $(this).scrollTop() > 0 && $menu.hasClass("default") ){
	...
	$('.tabs-contacts li a').click(function(event) {
		...
		$(".marker-contact").removeClass("active");
		var selectTab = $(this).attr("href");
		var titleTab = $(this).attr("data-title");
		$(selectTab).fadeIn(200);
		$("#"+titleTab).addClass("active");
	  });

	  
	$('.marker-contact').click(function(event) {
		event.preventDefault();
		$(".marker-contact").removeClass("active");
		$(this).addClass('active');
		var titleTab = $(this).attr("id");
		$("[data-title='" + titleTab + "']").click();
	  });
